...
alter table beer_order_line add constraint FKslskqsf79v6iekvb6d3gcc1l4 foreign key (beer_id) references beer
alter table beer_order_line add constraint FKhkgofxhwx8yw9m3vat8mgtnxs foreign key (beer_order_id) references beer_order
create table beer (id bigint generated by default as identity, created_date timestamp, last_modified_date timestamp, version bigint, beer_name varchar(255), beer_style integer, min_on_hand integer, price decimal(19,2), quantity_to_brew integer, upc varchar(255), primary key (id))
create table beer_inventory (id bigint generated by default as identity, created_date timestamp, last_modified_date timestamp, version bigint, quantity_on_hand integer, beer_id bigint, primary key (id))
create table beer_order (id bigint generated by default as identity, created_date timestamp, last_modified_date timestamp, version bigint, customer_ref varchar(255), order_status integer, customer_id bigint not null, primary key (id))
create table beer_order_line (beer_id bigint not null, beer_order_id bigint not null, created_date timestamp, last_modified_date timestamp, order_quantity integer, quantity_allocated integer, version bigint, primary key (beer_id, beer_order_id))
create table brewery (id bigint generated by default as identity, created_date timestamp, last_modified_date timestamp, version bigint, brewery_name varchar(255), primary key (id))
create table customer (id bigint generated by default as identity, created_date timestamp, last_modified_date timestamp, version bigint, customer_name varchar(255), primary key (id))
alter table beer add constraint UK_p9mb364xktkjqmprmg89u2etr unique (upc)
alter table beer_inventory add constraint FKrcn9po4vdekbhm8mpoj5f35d9 foreign key (beer_id) references beer
alter table beer_order add constraint FK5siih2e7vpx70nx4wexpxpji foreign key (customer_id) references customer
alter table beer_order_line add constraint FKslskqsf79v6iekvb6d3gcc1l4 foreign key (beer_id) references beer
